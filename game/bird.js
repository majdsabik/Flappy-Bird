class Bird {
    ...
    constructor(spriteImage) {
        ...
        this.velocity = 0;
        this.lift = -8;
        this.birdPosition = { y: (HEIGHT / 2) - (BIRDSIZE.Width / 2), x: (WIDTH / 2) - (BIRDSIZE.Height / 2) };
    ...
    draw() {
        ...
        image(this.image, 0, 0, BIRDSIZE.Width, BIRDSIZE.Height, BIRDANIMATIONFRAME[animationFrame], 0, BIRDSIZE.Width, BIRDSIZE.Height);
        pop();
    }
    ...
    isDead() {
        return this.birdPosition.y >= HEIGHT - BIRDSIZE.Height - FLOOROFFSET ? true : false;
    }
